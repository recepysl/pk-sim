...
public class TransactionService : ITransactionService
{
    ...
    public ApiResponse<List<TransactionResponse>> GetByParameter(int accountId, int userId, decimal amount, string description)
    {
        var predicate = GetExpression(accountId, userId, amount, description);
    ...
    public ApiResponse<TransferResponse> Transfer(TransferRequest request)
    {
        ...
        transactionTo.CurrencyCode = "TRY";
        ...
        transactionFrom.CurrencyCode = "TRY";
    ...
    private Expression<Func<Transaction, bool>> GetExpression(int accountId, int userId, decimal amount, string description)
    {
        ...
        if (userId > 0)
            predicate.And(x => x.Account.UserId == userId);
        if (amount > 0)
